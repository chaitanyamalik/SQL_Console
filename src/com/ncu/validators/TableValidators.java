...
[1:16 PM, 2/13/2019] +91 90535 29259: databasevalidators
[1:16 PM, 2/13/2019] +91 90535 29259: package com.ncu.validators;
...
public class TableValidators{
	...
	public boolean TableValidators(String tableName, String flag)	{ 
		...
		try {
			...
			object.emptyTableName(databaseName);
			
			object.tableExists(databaseName);
	...
	private void TableExists(String tableName) throws TableExists {
		if(new File(tablePath+tableName).exists()){
